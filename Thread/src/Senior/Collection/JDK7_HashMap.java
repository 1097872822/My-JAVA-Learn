...
///**
// *@description:  JDK7 中HashMap的源码
// *@author: RRW friend_rrw@163.com
// *@create: 2020-06-14 18:41
// */
///*
//    主要代码：static int indexFor(int h, int length) {
//                return h & (length-1);//使用 & 运算 而不是用 % 运算，& 相对来说是以
//                                      //位运算的方式（000...1111）的方式比较，不管计算出
//                                      //来的值是多少，我只会取最后四位的数去算哈希;
//                      }
//
//     public V put(K key, V value) { //put的操作：
//        if (key == null)
...
//
//
//      //什么时候扩容： 注意扩容之后还是会重写计算哈希的；所以最好不让它扩容
