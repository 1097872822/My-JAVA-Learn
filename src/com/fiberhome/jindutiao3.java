 ...
 * @create: 2020-08-24 20:18
 */
public class jindutiao3 extends JDialog implements MouseListener,
        MouseMotionListener {
    ...
    public static void main(String[] args) {
        int max = 20;
        jindutiao3 dlgMain = new jindutiao3(max);
