...
/**
 *@description:  旋转等待dialog
 *@author: RRW friend_rrw@163.com
 *@create: 2020-08-25 13:45
 */

public class juhuaquan2 extends JComponent implements MouseListener {
    ...
    public juhuaquan2(String text) {
        this(text, 14);
    }

    public juhuaquan2(String text, int barsCount) {
        this(text, barsCount, 0.70f);
    }

    public juhuaquan2(String text, int barsCount, float shield) {
        this(text, barsCount, shield, 15.0f);
    }

    public juhuaquan2(String text, int barsCount, float shield, float fps) {
        this(text, barsCount, shield, fps, 300);
    }

    public juhuaquan2(String text, int barsCount, float shield, float fps, int rampDelay) {
        this.text = text;
    ...
    protected class Animator implements Runnable {
        ...
        public void run() {
            ...
            if (!rampUp) {
                ...
                setVisible(false);
                removeMouseListener(juhuaquan2.this);
            }
        }
    }
